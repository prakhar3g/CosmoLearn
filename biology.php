                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-12 wow fadeInLeft">
                            ...
                            <form action="logout.php" method="post"> 
                                ...
                                <p  style="float:left; font-size:19px; letter-spacing: 1px;font-family: 'Josefin Sans', sans-serif;">The human heart is an organ that pumps blood throughout the body via the circulatory system, supplying oxygen and nutrients to the tissues and removing carbon dioxide and other wastes.
                                    <br><br>
                        ...
                        <div class="col-md-5 col-sm-12 wow fadeInLeft" data-wow-delay="0.3s">
                            ...
                            <img src="img/content/3.jpg" alt="" width="390px" style="margin-top:-95%; margin-left:170%;">
